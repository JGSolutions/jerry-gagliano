...
It could be problematic especially if your trying to accomplish a good score on Lighthouse. There are ways to overcome this problem.

**Lazy Load or Tree Shaking**
SPAs initially loads, it begins with a specific route. It maybe a login, dashboard, registration screen. You will have initial Javascript code that will
need to execute for inital app. Once that is loaded, only then the Javascript for that specific view is rendered. All your other views will not be loaded on the client
side until they request that view! Frameworks like Angular CLI, Vue.js and React Routing offer this pattern. With Lighthouse, I was able to reach scores
for performance 90 and above.
...
and the service worker will restart and re-initialize. I can be totally wrong about this but from my experince I never saw this. If anyone has any good solutions to this please email!
