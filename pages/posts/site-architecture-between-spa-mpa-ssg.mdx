...
With SPAs, all static files (CSS, Javascript) are loaded on the initally. Views will be rendered with data
...
and develop components all over your site and loading kilobytes of Javascript! 

If love your ReactJS or some other library and need to use it, then their are frameworks like Next.js, Astro that help you
