...
The purpose of this blog is not to demostrat how to implement MailChimp but more an overview of microservices architecture.
...
As you can see, the architecture is separated layers from front-end to back-end. 

In some cases, monolithic architecting could still be in favour and work well for certain 
developers or environments. Usually a high percentage of sites or applications are architected as mircoservices.
