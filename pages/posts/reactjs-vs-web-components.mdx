...
To use web components, no extra library is needed to run components on the browser. Just import the module
to your project and use it as a regular HTML element. Web components run natively on the browser as suppose to ReactJS, which requires
