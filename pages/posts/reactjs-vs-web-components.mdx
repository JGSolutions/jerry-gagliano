...
As you can see, web components have come a long way and growing in populartity. Developers should begin to embrace them
as it will push the web to it's limits.

I feel eventually the rate that Web components are heading, it will take over ReactJS and leave it behind they way the Web left JQuery.
