...
which the library will compile the source code into web components.
...
I feel eventually the rate that Web components are heading, it will take over ReactJS and leave it behind they way the JavaScript left JQuery.
