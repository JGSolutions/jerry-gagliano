...
One other great advantage is the hosting cost effectiveness and speed to deploy your SPAs. You can simply deploy your app to any global static CDN server. 
